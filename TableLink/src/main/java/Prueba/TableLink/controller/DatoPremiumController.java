...
import Prueba.TableLink.service.DatoPremiumService;
...
public class DatoPremiumController {

    @Autowired
    private DatoPremiumService usuarioPremiumServices;
    ...
    public ResponseEntity<List<DatoPremium>> listar(){
        List<DatoPremium> usuario = usuarioPremiumServices.findAll();
        if(usuario.isEmpty()){
    ...
    public ResponseEntity<DatoPremium> buscar(@PathVariable long id) {
        try{
            DatoPremium usuarioPremium = usuarioPremiumServices.getById(id);
    ...
    public ResponseEntity<?> registrar(@RequestBody DatoPremium usuarioPremium) {
        try{
        DatoPremium nuevoUsuarioPremium = usuarioPremiumServices.save(usuarioPremium);
    ...
    public ResponseEntity<DatoPremium> patchUsuarioPremium(@PathVariable Long id, @RequestBody DatoPremium usuarioPremium) {
        try {
            DatoPremium updatedUsuario = usuarioPremiumServices.patchUsuarioPremium(id, usuarioPremium);
